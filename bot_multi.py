...
from src.bot_commands import CommandHandler
...
class MultiChannelJobMonitorBot:
    ...
    def __init__(self):
        ...
        # Command handler (extracted to separate module)
    ...
    async def run(self) -> None:
        ...
        command_processor = asyncio.create_task(self.command_handler.process_commands())
